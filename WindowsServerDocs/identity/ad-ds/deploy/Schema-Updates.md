...
This topic lists the LDF files that include the changes that Adprep.exe makes in  Windows Server 2012 R2 and Windows Server 2016.  
...
## <a name="BKMK_SchemaUpdates2016"></a>Schema Updates in Windows Server 2016  
